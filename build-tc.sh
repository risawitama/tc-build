...
# GH_PUSH_REPO_URL | Your Repository for store compiled Toolchain ( without https:// or www. )
...
./build-llvm.py \
	...
	--targets "ARM;AArch64;X86;SystemZ" \
	--shallow-clone \
	--incremental \
	--install-stage1-only \
...
./build-binutils.py --targets arm aarch64 x86_64 s390x
